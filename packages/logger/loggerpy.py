...
methods included - setTroubleShoot()    ->    used to set the the log level - 
    ...
    def __init__(self , isOnWindows , isOnLinux , simpleWindowsPath , linuxPath):
        self.troubleShoot = False
        if(isOnWindows):
            self.logFileName = simpleWindowsPath + "/jarvisLogs.log"
        elif(isOnLinux):
            self.logFileName = linuxPath + "/jarvisLogs.log"
